    ...
    return Scaffold(
      ...
      body: Center(
        child: Container(
          ...
          decoration: BoxDecoration(
              image: DecorationImage(
                  image: AssetImage('images/qwerty.png'),
                  fit: BoxFit.cover)),
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: <Widget>[
              ...
              Card(
                ...
                child: ListTile(
                  ...
                  title: Text(
                    'Address: Palisoc, Bautista, Pangasinan',
                    style: TextStyle(
                      color: Color.fromARGB(255, 0, 0, 0),
                      fontFamily: 'Source Sans Pro',
                      fontSize: 18.0,
              ...
              Card(
                ...
                child: ListTile(
                  ...
                  title: Text(
                    'Email: wapuuguillermo@gmail.com',
                    style: TextStyle(
                      color: Color.fromARGB(255, 0, 0, 0),
                      fontFamily: 'Source Sans Pro',
                      fontSize: 18.0,
